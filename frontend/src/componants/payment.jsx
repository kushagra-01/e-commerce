...
export const Payment = () =>{
  ...
  const [form, setform] = useState({});
    ...
    const confirm = () => {
      ...
      if((form.name && form.card.length===16 && form.cvv && form.expire)  || (form.name2 && form.upi && form.mobno.length==10)){
    ...
    return(
      ...
      <div className="paydiv">
        ...
        <div className="ordersum">
          ...
          <button style={{ border: "1px solid white" }} onClick={confirm}>
            Make a PAYMENT
          </button>
        </div>
      </div>
